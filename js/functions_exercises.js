...
function ini(){
  ...
  $('button[class="envio-comentario"]').click( function(){
    alert("entra");
            ...
            output += '<hr/>';
              output += '<div class="row">';
                output += '<div class="col-sm-12">';
                  output += '<h3>Enviar comentario a la editorial</h3>';
                  output += '<div id="div_btn_classroom">';
                    output += '<button class="btn btn-labeled btn-info envio-comentario" data-toggle="modal" data-target="#myModal" data-l="true" data-id="'+(data["dictionary_lectures"])[l]["id"]+'" rel="tooltip" data-placement="bottom" data-original-title="Enviar comentario a la editorial" data-html="true"><span class="btn-label"><i class="glyphicon glyphicon-envelope"></i></span>Enviar comentario</button>';
                  output += '</div>';
                output += '</div>';
              output += '</div>';
          output += '</div>';
            ...
            output += '<hr/>';
              output += '<div class="row">';
                output += '<div class="col-sm-12">';
                  output += '<h3>Enviar comentario a la editorial</h3>';
                  output += '<div id="div_btn_classroom">';
                    output += '<button class="btn btn-labeled btn-info envio-comentario" data-toggle="modal" data-target="#myModal" data-l="false" data-id="'+(data["dictionary_exercises"])[e]["id"]+'" rel="tooltip" data-placement="bottom" data-original-title="Enviar comentario a la editorial" data-html="true"><span class="btn-label"><i class="glyphicon glyphicon-envelope"></i></span>Enviar comentario</button>';
                  output += '</div>';
                output += '</div>';
              output += '</div>';
          output += '</div>';
            ...
            output += '<hr/>';
              output += '<div class="row">';
                output += '<div class="col-sm-12">';
                  output += '<h3>Enviar comentario a la editorial</h3>';
                  output += '<div id="div_btn_classroom">';
                    output += '<button class="btn btn-labeled btn-info envio-comentario" data-toggle="modal" data-target="#myModal" data-l="true" data-id="'+(data["dictionary_homeworks"])[h]["id"]+'"  rel="tooltip" data-placement="bottom" data-original-title="Enviar comentario a la editorial" data-html="true"><span class="btn-label"><i class="glyphicon glyphicon-envelope"></i></span>Enviar comentario</button>';
                  output += '</div>';
                output += '</div>';
              output += '</div>';
          output += '</div>';
